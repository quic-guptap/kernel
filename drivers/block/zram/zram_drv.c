...
size_t zram_get_compr_size_for_swp_entry(swp_entry_t entry)
{
	...
	/*
	 * Identify the ZRAM device by its registered major number.
	 * This avoids a direct pointer comparison against the static
	 * zram_devops struct which is not accessible outside this file.
	 */
